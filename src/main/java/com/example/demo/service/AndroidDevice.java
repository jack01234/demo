...
String url = "https://dfp-test.xinyan.com/gateway/device-engine-client/android/v2/gather";     //MOCK测试
...
//       一级参数匹配
                ...
                jsonDto.put("xyid", "11901161550599897835116");
                jsonDto.put("screenRes", "1440*2408");
                jsonDto.put("unittype", "122");
                jsonDto.put("bios", "BL29627");
                jsonDto.put("cpu", "172");
                jsonDto.put("androidId", "135");
//       二级参数匹配
                jsonDto.put("devicename", "1231231231");
                jsonDto.put("sysVer", "12.0.1");
                jsonDto.put("imei", "1231231231233333333333333333333");
                jsonDto.put("phonenum", "258");
                jsonDto.put("imsi", "1231231231233333333333333333333");
                jsonDto.put("timezone", "GMT+08:00,Asia/beijing");
                jsonDto.put("systemlan", "US");
                jsonDto.put("isroot", "0");
                jsonDto.put("fontnum", UUID.randomUUID());
                jsonDto.put("isVirtualApp", "1");
                jsonDto.put("screenres", "1081*2040");
                jsonDto.put("fcpu", "372");
                jsonDto.put("totalSize", "975175.68");
                jsonDto.put("mac", "1c:77:f6:2d:50:1e");
                ...
                jsonDto.put("uniqueId","2018112811474321931531667652574099fcd7f6d733c138f7f9f94d5abed791");
