...
/**
 * Terminate Condition implementation for .
 */
public class OptimizeMakeChangeTerminateCriteria implements ITerminateCriteria {
     ...
     */
    public OptimizeMakeChangeTerminateCriteria(Ignite ignite, Consumer<String> logConsumer) {
        this.ignite = ignite;
    ...
    private String reportCoins(List<Gene> genes) {
        ...
        for (Gene gene : genes) {
            sb.append("\nCoin Type: ").append(((Coin)gene.getValue()).getCoinType().toString())
                .append("\nNumber of Coins: ").append(((Coin)gene.getValue()).getNumOfCoins());
        }
