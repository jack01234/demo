...
import com.example.demo.ip2region.DbMakerConfigException;
...
public class TestUnit {
    ...
    public static void main(String[] args) {
        try {
            DbSearcher _searcher = new DbSearcher(new DbConfig(), "E:\\设备指纹相关\\ip解析\\ip2region.db");
            BufferedReader bfr   = new BufferedReader(new FileReader("E:\\设备指纹相关\\ip解析\\ip.merge.txt"));
            BufferedWriter bwr   = new BufferedWriter(new FileWriter("E:\\设备指纹相关\\ip解析\\error_log.txt", true));
            int errCount  = 0;
            int lineCount = 0;
            String str = null;
